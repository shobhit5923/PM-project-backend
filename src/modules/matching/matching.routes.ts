...
router.post('/re-match', requireAuth, async (_req: AuthRequest, res) => {
  reMatchAllOpenReports().catch((err) =>
    console.error('Background retro-matching error:', err)
  );
...
router.get('/my', requireAuth, async (req: AuthRequest, res) => {
  try {
    ...
    reMatchAllOpenReports().catch((e) =>
      console.error('Background retro-match error:', e)
    );
