 ...
 */
function isAnswerCorrect(userAnswer, expectedAnswer, foundDescription, foundReport) {
...
export async function submitVerificationAnswers(matchId, answers) {
    ...
    for (const ans of answers) {
        ...
        if (!question)
            continue;
        const isCorrect = isAnswerCorrect(ans.answer, question.expectedAnswer, matchObj?.foundReport?.description, matchObj?.foundReport);
